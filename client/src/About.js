    ...
    return (
      ...
      <div className = "about">
          ...
          <div className = "aboutinfo">
            ...
            <p className = "aboutp">Log. Ai was born out of curiosity, appreciation for the hard work that people in the logistics industry put in everyday, and the desire to serve our nation, again. In 2008, Rodolfo Valdivia, New York City native and son of immigrants, joined the Marine Corps, in gratitude for what this country did for his parents and his love for his country. After his deployments to Iraq and Afghanistan as a Motor Transport Mechanic, he was able to see first-hand that logistical operations were the heart-beat of mission accomplishment.</p>

            <img className = "smallpic" alt = "finance" src = {finance} ></img>

            <p className = "aboutp"> After graduating college, Rodolfo wanted to switch gears and serve his nation again by working in finance, hoping to do his part to help strengthen the economy. Interestingly enough, while working in finance, he realized that as e-commerce continues to grow and our economy becomes more interconnected with other parts of the world, the logistics industry will only become more important to our economy's growth as we move forward.  While doing more research, he realized that this industry is constantly being challenged by huge demand to transport goods while facing shortage of truck-drivers and lack of technological innovation (besides testing self-driving trucks at the time).
